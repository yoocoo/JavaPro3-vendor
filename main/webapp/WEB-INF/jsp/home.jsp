...
<div class="container body">
    <div class="main_container">
                            ...
                            <div class="x_content">
                                ...
                                <%--<div class="col-md-2">--%>
                                    ...
                                    <%--<input class="knob" data-width="100" data-height="120" data-min="-10000"--%>
                                           <%--data-displayPrevious=true data-fgColor="#26B99A" data-max="10000"--%>
                                           <%--data-step=".1" value="0">--%>
                                <%--</div>--%>
                                <div class="col-md-2">
                                    <p>故障机器</p>
                                    <input class="knob" data-width="100" data-height="120" data-angleOffset=-125
                                           data-angleArc=250 data-fgColor="#8B0000" data-rotation="anticlockwise"
                                           value="35">
                                </div>
                                <div class="col-md-2">
                                    <p>销售数目</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <section id="brand">
                                    <h2 class="page-header">${userInfo.accountName}----售货机列表</h2>
                                    ...
                                    <div class="row fontawesome-icon-list">
                                        <c:if test="${userMess.roleId ==6||userMess.roleId ==8||userMess.roleId ==10 }">
                                            <c:forEach items="${sVnameList}" var="slist">
                                                <div class="fa-hover col-md-3 col-sm-4 col-xs-12"><a href="#"><i
                                                        class="fa fa-empire"></i>${slist.vendorName}</a>
                                                </div>
                                            </c:forEach>
                                        </c:if>
                                        <c:if test="${userMess.roleId ==3||userMess.roleId ==4||userMess.roleId ==5}">
                                            <c:forEach items="${yVnameList}" var="ylist">
                                                <div class="fa-hover col-md-3 col-sm-4 col-xs-12"><a href="#"><i
                                                        class="fa fa-empire"></i>${ylist.vendorName}</a>
                                                </div>
                                            </c:forEach>
                                        </c:if>
                                    </div>
        ...
        <script type="text/javascript" src="<c:url value='/static/vendors/skycons/skycons.js'/>"></script>
            <!-- jQuery Knob -->
            <script type="text/javascript"
                    src="<c:url value='/static/vendors/jquery-knob/dist/jquery.knob.min.js'/>"></script>
        <!-- Flot -->
        ...
        <script type="text/javascript"
                src="<c:url value='/static/vendors/flot-spline/js/jquery.flot.spline.min.js'/>"></script>
        ...
        <%--<script type="text/javascript"--%>
                <%--src="<c:url value='/static/vendors/jqvmap/dist/maps/jquery.vmap.world.js'/>"></script>--%>
        <%--<script type="text/javascript"--%>
