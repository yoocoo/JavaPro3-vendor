                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <!-- Smart Wizard -->
                                    <p> 1：运营商下属用户概述：是本系统的三级用户&nbsp; 2：运营商仓库用户职责：管理货品，运营商配货员：负责配货 <br>
                                        3：运营商下属用户权限：拥有该系统三级权限&nbsp; 4：运营商管理员用户工作范围：覆盖三级用户。
                                    </p>
