            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <input type="button" value="更新关联菜单"
                                      onclick="GetRoleMenu();" id="rolemenu" class="btn-success btn-mini"/>
                        ...
                        <table class="table table-bordered data-table ">
                            ...
                            <%--<tr class="gradeX">--%>
                            <%--<c:forEach items="${roleMenuList}" var="list">--%>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <input type="button" value="更新权限菜单" id="menu"
            ...
            <div class="span12">
                <%--<div class="widget-box">--%>
                    ...
                    <%--<div class="widget-content nopadding">--%>
                        ...
                        <%--</table>--%>
                    <%--</div>--%>
                    <%--&lt;%&ndash;======== js   start 测试 6.14=== 表一 ==&ndash;%&gt;--%>
